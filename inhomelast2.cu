...
__global__ void Compute_eigsts0(cuDoubleComplex *dfdphi_d, double *eigsts,
                               double *Chom11_d, double *Chom12_d, 
...
__global__ void Compute_eigsts1(cuDoubleComplex *dfdphi_d, double *eigsts,
                               double *Chom11_d, double *Chom12_d, 
                               double *Chom44_d, double *Chet11_d, 
                               double *Chet12_d, double *Chet44_d, 
                               int *ny_d, int *nz_d)
...
__global__ void Compute_eigsts2(cuDoubleComplex *dfdphi_d, double *eigsts,
                               double *Chom11_d, double *Chom12_d, 
                               double *Chom44_d, double *Chet11_d, 
                               double *Chet12_d, double *Chet44_d, 
                               int *ny_d, int *nz_d)
...
__global__ void Compute_persts(double *Chom11_d, double *Chom12_d, 
                     ...
                     double *Chet44_d, cuDoubleComplex *dfdphi_d, 
...
__global__ void Compute_ts(cuDoubleComplex *ts0_d, cuDoubleComplex *ts1_d,
